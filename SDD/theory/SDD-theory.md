...
**PASO 2 — Generación de specs.** Para cada tarea (o grupo de tareas relacionadas) en `phaseX.md`, se redacta una spec usando la plantilla [`SPEC-TEMPLATE.md`](../templates/SPEC-TEMPLATE.md). La spec se registra en [`SPEC_INDEX.md`](../SPEC_INDEX.md) y se vincula desde `phaseX.md`. No se escribe código sin spec aprobada (🔵). Quién lo hace: arquitecto, estudiante Sr., o LLM supervisado.
...
- [`SPEC_INDEX.md`](../SPEC_INDEX.md) — tabla de lookup
